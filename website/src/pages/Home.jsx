...
function Home() {
  ...
  return (
    <>
      <div className="grid md:grid-cols-5 grid-cols-1 gap-4 ml-4 mr-4 mb-4">
        {/* YouTube */}
        <Link to="/icons/youtube">
          <div className="card bg-base-100 w-auto border border-2 hover:scale-95 transition delay-150">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <div className="dropdown dropdown-bottom dropdown-end">
                <div tabIndex={0} role="button" className="btn m-1">Download</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-36 p-2 border border-2">
                  <li onClick={DownloadMediumPng}><a>.png</a></li>
                  <li onClick={DownloadMediumJpg}><a>.jpg</a></li>
                  <li onClick={DownloadMediumSvg}><a>.svg</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <div className="dropdown dropdown-bottom dropdown-end">
                <div tabIndex={0} role="button" className="btn m-1">Download</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-36 p-2 border border-2">
                  <li onClick={DownloadTikTokPng}><a>.png</a></li>
                  <li onClick={DownloadTikTokJpg}><a>.jpg</a></li>
                  <li onClick={DownloadTikTokSvg}><a>.svg</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="card bg-base-100 w-auto border border-2">
          ...
          <div className="card-body">
            <h2 className="card-title">Behance</h2>
            <div className="card-actions justify-end">
              <div className="dropdown dropdown-bottom dropdown-end">
                <div tabIndex={0} role="button" className="btn m-1">Download</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-36 p-2 border border-2">
                  <li onClick={DownloadBehancePng}><a>.png</a></li>
                  <li onClick={DownloadBehanceJpg}><a>.jpg</a></li>
                  <li onClick={DownloadBehanceSvg}><a>.svg</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <div className="dropdown dropdown-bottom dropdown-end">
                <div tabIndex={0} role="button" className="btn m-1">Download</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-36 p-2 border border-2">
                  <li onClick={DownloadXPng}><a>.png</a></li>
                  <li onClick={DownloadXJpg}><a>.jpg</a></li>
                  <li onClick={DownloadXSvg}><a>.svg</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <div className="dropdown dropdown-bottom dropdown-end">
                <div tabIndex={0} role="button" className="btn m-1">Download</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-36 p-2 border border-2">
                  <li onClick={DownloadWhatsAppPng}><a>.png</a></li>
                  <li onClick={DownloadWhatsAppJpg}><a>.jpg</a></li>
                  <li onClick={DownloadWhatsAppSvg}><a>.svg</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="card bg-base-100 w-auto border border-2">
          ...
          <div className="card-body">
            <h2 className="card-title">WeChat</h2>
            <div className="card-actions justify-end">
              <div className="dropdown dropdown-bottom dropdown-end">
                <div tabIndex={0} role="button" className="btn m-1">Download</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-36 p-2 border border-2">
                  <li onClick={DownloadWeChatPng}><a>.png</a></li>
                  <li onClick={DownloadWeChatJpg}><a>.jpg</a></li>
                  <li onClick={DownloadWeChatSvg}><a>.svg</a></li>
                </ul>
              </div>
            </div>
          </div>
